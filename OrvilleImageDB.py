...
class OrvilleImageDB(object):
    ...
    class _FileHeader_v1(ctypes.LittleEndianStructure):
        _pack_   = 1
    ...
    class _EntryHeader_v1(ctypes.LittleEndianStructure):
        _pack_   = 1
    ...
    class _EntryHeader_v2(ctypes.LittleEndianStructure):
        _pack_   = 1
        _fields_ = [('sync_word',  ctypes.c_uint),
                    ('start_time', ctypes.c_double),
                    ('int_len',    ctypes.c_double),
