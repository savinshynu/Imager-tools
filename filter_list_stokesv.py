...
narrowband RFIs and airplane from the transient search list in Stokes V
"""
...
from low_snr_stokesv import filter_snr
import h5py
from narrow_rfi_stokesv import flag_narrow_rfi as fnr
...
path1 = "/leo/savin/wide_lwasv/oims_wide/standard_sub/transients_stokesv/"+str(int(day))+"/*.txt"
files1 = sorted(glob.glob(path1))

path2 = "/leo/savin/wide_lwasv/oims_wide/standard_sub/corr_transients_stokesv/"+str(int(day))+"/"
try:
    os.mkdir(path2)
except OSError:
