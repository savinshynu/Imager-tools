...
"""
def response_sing_antenna(f,az,alt):
    config ={}
    config['freq'] = float(f)*1e6
    config['corr'] = False
    config['verbose'] = False
    config['args'] = []
    ...
    # Display
    #plt.show()
    #plt.imshow(stokes_i_pattern)
    #plt.show()
    #plt.plot(range(360),stokes_i_pattern[0,:])
    #plt.plot(range(360),stokes_i_pattern[30,:])
    #plt.plot(range(360),stokes_i_pattern[80,:])
    #plt.show()
    #print stokes_i_pattern.shape ,stokes_i_pattern[10,0],stokes_i_pattern[10,80]
    return stokes_i_pattern
    
if __name__ == "__main__":
    response_sing_antenna(50)
